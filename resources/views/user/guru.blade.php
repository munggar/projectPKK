...
<head>
    ...
    <title>HALAMAN GALERI GURU</title>
        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">GALERI FOTO GURU</h2>
                    <h3 class="section-subheading text-muted">"Dibawah ini adalah foto-foto guru yang mengajar di kelas XII RPL 2"</h3>
                </div>
                <div class="row">
                    @foreach ($galeri as $g)
                            ...
                            <div class="portfolio-item">
                                <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal{{ $g->id }}">
                                    ...
                                    @if (!preg_match('/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=_|!:,.;]*[-a-z0-9+&@#\/%=_|]/i', $g->foto))
                                        <img class="img fuild" src="{{ asset('Guru/' . $g->foto) }}" width="355px"
                                            height="250px"alt="not found" srcset="">
                                    @else
                                        <img class="img fuild" src="{{ $g->gambar }}" width="355px"
                                            height="250px"alt="not found" srcset="">
                                    @endif
                                </a>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                <!-- Project details-->
                                <h6 align="center" style="color: #8d8d8d">Nama Guru</h6>
                                <h4 class="text-capitalize">{{ $item->jud }}</h4><br>
                                @if (!preg_match(
                                    '/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=_|!:,.;]*[-a-z0-9+&@#\/%=_|]/i',
                                    $item->foto))
                                    <img class="img fuild" src="{{ asset('Guru/' . $item->foto) }}"
                                        width="355px" height="250px" alt="not found" srcset="">
                                @else
                                    <img class="img fuild" src="{{ $item->foto }}" width="355px"
                                        height="250px"alt="not found" srcset="">
                                @endif
                                <h6 align="center" style="color: #8d8d8d">Mengajar Mata Pelajaran</h6>
                                <p>{{ $item->ket }}</p>
