...
<body>
	<section class="login">
		<div class="login_box">
			<div class="left">
				<div class="top_link"><a href="/makeg"><img src="https://drive.google.com/u/0/uc?id=16U__U5dJdaTfNGobB_OpwAJ73vM50rPV&export=download" alt="">Return home</a></div>
				<div class="contact">
			...
			<div class="right">
				<div class="right-text">
					<h2>Masukan Data</h2>
					<h5>Menambah data mapel & kegiatan siswa</h5>
				</div>
