        ...
        <div class="container-scroller">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    ...
                    <a href="/tambah_kegiatan" style="position:relative; top:497px; left:336px"
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    @if (!preg_match('/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i', $f->foto))
                                        <img class="img fuild" src="{{ asset('jadwal_pelajaran/' . $f->foto) }}"
                                ...
                                <td>{{ $f->judul }}</td>
                                <td>{{ $f->keterangan }}</td>
                                <td><a class="btne" href={{ url('ed', $f->id) }}><i
                                            class="fa-solid fa-pen-to-square"></i></a> |</a> <a class="btne"
                                        href={{ 'del/' . $f['id'] }}><i class="fa-solid fa-trash-can"></i></a></td>
                            </tr>
                        @endforeach
                </div>
            </div>
