...
<head>
    ...
    <title>HALAMAN KOMPETENSI</title>
    @include('adm.head')
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <button type="button" style="position:relative;top: 510px;left: 221px;" class="btn btn-primary"
                        data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Import Data
                    </button>
                    <a href="{{ route('kompetensiexport') }}" style="position:relative;top: 510px;left: 226px;"
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('kompetensiimport') }}" method="POST"
                    ...
                    <a class="btn btn-primary btn-xl" href="{{ route('create') }}"  style="position:relative;top: 510px;left: 231px;">Tambahkan Data</a>
                    <table class="tble table-bordered border-primary" border="5px" cellpadding="5px">
                        <tr align="center">
                            <th>NO</th>
                            <th>Foto</th>
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    @if (!preg_match('/\b(?:(?:https?|ftp):\/\/|www\.)[-a-z0-9+&@#\/%?=~_|!:,.;]*[-a-z0-9+&@#\/%=~_|]/i', $f->gambar))
                                        <img class="img fuild" src="{{ asset('image/' . $f->gambar) }}" width="80px"
                                ...
                                <td>{{ $f->judul }}</td>
                                <td>{{ $f->keterangan }}</td>
                                <td><a class="btne" href={{ 'edit/' . $f['id'] }}><i
                                            class="fa-solid fa-pen-to-square"></i></a> | <a class="btne"
                                        href={{ 'hap/' . $f['id'] }}><i class="fa-solid fa-trash-can"></i></a></td>
                            </tr>
                        @endforeach
                </div>
            </div>
