        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <button type="button" style="position:relative;top: 484px;left: 221px;" class="btn btn-primary"
                        data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Import Data
                    </button>
                    <a href="{{ route('beritaexport') }}" style="position:relative; top: 484px;left: 232px;"
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('beritaimport') }}" method="POST"
                    ...
                    <a href="{{ route('buatber') }}" style="position:relative; top: 484px;left: 242px;"
                        class="btn btn-primary">Tambahkan Data</a>
                    <table class="tabel table-bordered border-primary" border="5px" cellpadding="5px">
                        <tr align="center">
                            <th>NO</th>
                            <th>Foto</th>
                            <th>Judul</th>
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    @if (!preg_match(
                                        ...
                                        $f->subfoto))
                                        <img class="img fuild" src="{{ asset('Berita/' . $f->subfoto) }}"
                                            width="80px" height="80px" alt="not found" srcset="">
                                    @else
                                        <img class="img fuild" src="{{ $f->subfoto }}" width="80px"
                                            height="80px" alt="not found" srcset="">
                                    @endif
                                </td>
                                <td>{{ $f->subjudul }}</td>
                                <td>{{ $f->subket }}</td>
                                <td><a class="btne" href={{ url('ditdit', $f->id) }}><i
                                            class="fa-solid fa-pen-to-square"></i></a> | <a class="btne"
                                        href={{ url('puspus', $f->id) }}><i class="fa-solid fa-trash-can"></i></a></td>
                            </tr>
                        @endforeach
                </div>
            </div>
