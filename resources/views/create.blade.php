...
<body>
    <div class="bod">
        <h1 align="center"><strong><em>HALAMAN MENAMBAHKAN KOMPETENSI SEKOLAH</em></strong></h1>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="file" class="form-control" id="gambar"
                                    placeholder="Masukan Judul Kompetensi" name="gambar" required><br>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control"
                                    placeholder="Masukan Keterangan pada Kompetensi" name="keterangan" required><br>
                            </div>
    ...
    <div class="form-group row">
        <br>
        <div class="container">
            <a href="{{ route('kompetensi') }}"><button type="button" class="btn btn-primary"
                    style="position:absolute; left: 780px; top: 616px;">Kembali</button></a>
        </div>
</body>
