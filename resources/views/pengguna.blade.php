        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <table class="tabl table-bordered border-primary" border="5px" cellpadding="5px">
                        <tr align="center">
                            <th>NO</th>
                            <th>PROFIL</th>
                            <th>NAMA</th>
                            ...
                            <tr align="center">
                                ...
                                <td>
                                    @if (!preg_match(
                                        ...
                                        $item->foto))
                                        <img class="img fuild" src="{{ asset('User/' . $item->foto) }}" width="80px"
                                            height="80px" alt="not found" srcset="">
                                    @else
                                        <img class="img fuild" src="{{ $item->foto }}" width="80px"
                                            height="80px" alt="not found" srcset="">
                                    @endif
                                </td>
                                <td>{{ $item->name }}</td>
                                ...
                                <td>{{ $item->email }}</td>
                                <td>{{ $item->level }}</td>
                                <td><a class="btne" href={{ 'hpus/' . $item['id'] }}><i
